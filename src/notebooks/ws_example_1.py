def ws_example_1():
    ...
    dir_name = os.getcwd()
    workspace = os.path.join(dir_name + 'presentation_files/models/mf6', "ws_example_1")
    workspace = "C:/Users/lucialabarca/re-run noteboks/pymf6-validation/src/notebooks/presentation_files/models/mf6/ws_example_1"

    # Set up workspace
    model_name = "ws_example_1"
    gwfmodel_name = "gwf_ws_example_1"
    ...
    # Get data from the second stress period
    iper = 0
    ...
    # Using Flopy PlotMapView capabilities for MODFLOW 6
